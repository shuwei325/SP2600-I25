...
```{r, results='hide',  echo=FALSE, out.width = "60%", fig.align="center"}
...
(r = round(acf(rec, 6, plot=FALSE)$acf[-1], 3)) # first 6 sample acf values
...
```{r, results='hide', echo=FALSE,warning=FALSE, message=FALSE, fig.align="center", out.width = "60%"}
par(mfrow=c(2,1))
...
```{r, results='hide',warning=FALSE, message=FALSE, fig.align="center", out.width = "50%"}
par(mfrow=c(2,1))
